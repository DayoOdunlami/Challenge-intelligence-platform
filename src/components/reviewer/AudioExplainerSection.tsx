          ...
          <div className="bg-gray-800 rounded-lg p-8 mb-8 border-2 border-[#006E51] shadow-xl">
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center space-x-4">
                <button
                  onClick={togglePlay}
                  className="w-16 h-16 bg-[#006E51] hover:bg-[#005A42] rounded-full flex items-center justify-center transition-colors duration-200 shadow-lg"
                  title="Play Innovation Atlas audio"
                >
                  {isPlaying ? (
